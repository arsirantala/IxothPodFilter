sed -i -e "s|^ItemDisplay\[gzv\]:$|//ItemDisplay\[gzv\]\:|g" ../item.filter
sed -i -e "s|^ItemDisplay\[glw\]:$|//ItemDisplay\[glw\]\:|g" ../item.filter
sed -i -e "s|^ItemDisplay\[glg\]:$|//ItemDisplay\[glg\]\:|g" ../item.filter
